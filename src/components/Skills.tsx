  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'JDBC', icon: '/images/icons/jdbc.png' },
    ...
    },
    {
      title: 'Soft Skills',
      skills: [
        { name: 'Problem Solving', icon: '/images/icons/problem-solving.svg' },
        { name: 'Quick Learning', icon: '/images/icons/quick-learn.svg' },
        { name: 'Team Work', icon: '/images/icons/team-collaboration.svg' },
        { name: 'Agile Method', icon: '/images/icons/scrum.svg' },
      ],
