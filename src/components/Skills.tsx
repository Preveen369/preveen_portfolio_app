  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Generative AI', icon: '/src/assets/images/icons/openai.svg' },
      ],
    ...
    },
    {
      title: 'Soft Skills',
      skills: [
        { name: 'Problem Solving', icon: '/src/assets/images/icons/problem-solving.svg' },
        { name: 'Quick Learning', icon: '/src/assets/images/icons/quick-learn.svg' },
        { name: 'Team Work', icon: '/src/assets/images/icons/team-collaboration.svg' },
        { name: 'Agile Method', icon: '/src/assets/images/icons/scrum.svg' },
      ],
